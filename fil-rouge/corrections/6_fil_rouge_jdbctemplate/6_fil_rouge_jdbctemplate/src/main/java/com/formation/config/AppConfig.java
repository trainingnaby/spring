...
public class AppConfig implements WebMvcConfigurer {
    ...
    // La datasource gére les connexions à la base de données. Elle est créée à partir des propriétés définies dans application.properties.
    @Bean
    ...
    public JdbcTemplate jdbcTemplate(DataSource dataSource) {
    	// JdbcTemplate doit connaitre le DataSource pour pouvoir se connecter à la base de données.
    	// Lui il ne se connecte pas directement, il délègue au DataSource.
    	// Il fait les opérations de base de données (insert, update, delete, select) et gère les exceptions SQL.
