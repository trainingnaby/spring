...
public class DuplicataMvcController {
    ...
    public String creerDuplicata(@Valid @ModelAttribute("duplicataDto") DuplicataDto duplicataDto, 
            BindingResult bindingResult, // IMPORTANT : doit être placé juste après le @ModelAttribute à valider
            RedirectAttributes redirectAttributes // permet de stocker des attributs de flash (disponibles uniquement pour la requete suivante, puis supprimés) pour afficher des messages après redirection
            ) {
