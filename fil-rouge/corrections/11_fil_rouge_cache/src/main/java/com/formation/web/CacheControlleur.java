 ...
 *
 * Important : dans une vraie application, ces routes devraient etre protegees
 * par Spring Security. Elles sont volontairement publiques dans ce TP afin de
 * faciliter les manipulations avec Swagger UI ou un navigateur.
 */
@RestController
