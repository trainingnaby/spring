...
@Service("formation_spring") // est un component et marquer que ce bean est un service
// @Repository est un marqueur des beans de la couche DAO : Spring fait de la traduction d'exception avec les beans 
// marqueurs @Repository (les exceptions de la couche DAO sont traduites en DataAccessException)
//@Lazy // le bean est instancié à la demande
