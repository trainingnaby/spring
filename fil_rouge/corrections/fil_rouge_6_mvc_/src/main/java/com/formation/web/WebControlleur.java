...
import com.formation.web.formulaires.FormulaireDuplicata;
...
public class WebControlleur {
	...
	public String listeDuplicatas(Model model) {
		...
		List<Duplicata> duplicatas = duplicataService.getDuplicatas();
	...
	public String creerDuplicata(@ModelAttribute FormulaireDuplicata formulaireDuplicata, BindingResult bindingResult,
			Model model) {
