...
public class DuplicataControlleur {
	...
	public  ResponseEntity<CollectionModel<EntityModel<Duplicata>>> listDuplicatas(){
		List<Duplicata> duplicatas =  duplicataService.listDuplicatas();
		CollectionModel<EntityModel<Duplicata>> collectionModel = duplicataModelAssembler.toCollectionModel(duplicatas);
	...
	public EntityModel<Duplicata> getDuplicatas(@PathVariable long id) throws DuplicataException {
		...
		// convertir le duplicata retourné avec un entityModel avec les liens
